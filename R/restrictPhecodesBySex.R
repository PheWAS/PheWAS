...
#' @param gender.exclusion the map used for gender exclusions
#'
...
restrictPhecodesBySex <- function(phenotypes,id.sex, gender.exclusion = PheWASmaps::gender_restriction) {
  ...
  current_gender_restriction=gender.exclusion[gender.exclusion$phecode %in% names(phenotypes)[-1],]
